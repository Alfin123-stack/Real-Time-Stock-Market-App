...
export const CHARTS = [
  {
    type: "symbolInfo",
    label: "Real-Time Stock Symbol",
    colSpan: "xl:col-span-2",
  },
  { type: "technicalAnalysis", label: "Technical Analysis", colSpan: "" },
  {
    type: "financials",
    label: "Fundamentals / Financials",
    colSpan: "xl:col-span-2",
  },
  { type: "symbolProfile", label: "Company Profile", colSpan: "" },
] as const;
